<x-guest-layout>
    @include('auth.navb')
    <div class="px-4 py-12 sm:px-6 lg:px-8 bg-gray-50">
        <x-authentication-card class="max-w-2xl mx-auto overflow-hidden border border-gray-100 shadow-xl bg-gradient-to-br from-white to-gray-50 rounded-2xl">
            ...
            <div class="px-6 py-4 text-center bg-green-500">
                ...
                <p class="mt-1 text-green-100">Join us today and get started with your organization</p>
            </div>

            <div class="relative">
                <!-- Gradient background overlay -->
                <div class="absolute inset-0 bg-gradient-to-r from-green-400 to-green-600 opacity-10"></div>
                ...
                <x-validation-errors class="p-4 mx-6 mt-4 border border-red-100 rounded-lg bg-red-50/80" />

                <form method="POST" action="{{ route('register') }}" class="relative px-8 py-6 space-y-6">
                    @csrf
                    ...
                    <div class="flex flex-col items-center justify-between mt-8 space-y-4 sm:flex-row sm:space-y-0">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-green-600 transition duration-200 hover:text-green-500 hover:underline">
                            Already have an account? Login
                        </a>

                        <x-button class="px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition duration-200 ease-in-out">
                            {{ __('Register') }}
